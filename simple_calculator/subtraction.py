...
"""This script is used to perform Substraction
...
class Substraction:
    ...
    """Class Substraction is used to perform Substraction operation"""

    def __init__(self, number_1, number_2):
        """The init function of the class Substraction
    ...
    def run(self):
        """ The main function for Class Substraction."""
...
def main(number_1="", number_2=""):
    ...
    parser = argparse.ArgumentParser(description="Substraction")
    ...
    if not number_1.strip() and not number_2.strip():
        ...
        if 1:
            ...
            submodule = Substraction(args.number_1, args.number_2)
            submodule.run()
        else:
