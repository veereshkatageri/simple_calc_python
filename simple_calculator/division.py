...
"""This script is used to perform Division
...
class Division:
    ...
    """Class Division is used to perform Division operation"""

    def __init__(self, number_1, number_2):
        """The init function of the class Division
    ...
    def run(self):
        """ The main function for Class Division."""
...
def main(number_1="", number_2=""):
    ...
    parser = argparse.ArgumentParser(description="Division")
    ...
    if not number_1.strip() and not number_2.strip():
        ...
        if 1:
            ...
            submodule = Division(args.number_1, args.number_2)
            submodule.run()
        else:
