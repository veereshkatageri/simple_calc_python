...
"""This script is used to perform Multiplication
...
class Multiplication:
    ...
    """Class Multiplication is used to perform Multiplication operation"""

    def __init__(self, number_1, number_2):
        """The init function of the class Multiplication
    ...
    def run(self):
        """ The main function for Class Multiplication."""
...
def main(number_1="", number_2=""):
    ...
    if not number_1.strip() and not number_2.strip():
        ...
        if 1:
            ...
            submodule = Multiplication(args.number_1, args.number_2)
            submodule.run()
        else:
