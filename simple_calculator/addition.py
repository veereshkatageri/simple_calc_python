...
"""This script is used to perform Addition
...
class Addition:
    ...
    """Class Addition is used to perform Addition operation"""

    def __init__(self, number_1, number_2):
        """The init function of the class Addition
        ...
        self.number_1 = int(number_1) if number_1.isdigit() else float(number_1)
        self.number_2 = int(number_2) if number_2.isdigit() else float(number_2)

    def run(self):
        """ The main function for Class Addition."""

        result = self.number_2 + self.number_1
...
def main(number_1="", number_2=""):
    ...
    if not number_1.strip() and not number_2.strip():
        ...
        if 1:
            ...
            submodule = Addition(args.number_1, args.number_2)
            submodule.run()
        else:
